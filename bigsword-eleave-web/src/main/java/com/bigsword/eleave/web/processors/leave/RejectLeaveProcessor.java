...
import com.bigsword.eleave.web.json.request.JsonRejectLeaveRequest;
...
public class RejectLeaveProcessor implements RequestProcessor{
	...
	public String process(WorkContext workContext) {
		...
		JsonRejectLeaveRequest json = (JsonRejectLeaveRequest)workContext.getJsonRequestObjectFromContext();
